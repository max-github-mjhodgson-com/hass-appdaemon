...
Areas covered are Grandstream SIP Doorphone, CCTV, House Mode, Garage, Calendar, Kitchen, Mobile App Events, Logitech Squeezebox (Networked music player), Car (using Fordpass) and a Telegram Command bot.
